...
public class FXMLResultWinBase extends AnchorPane {
    ...
    public FXMLResultWinBase(Stage stage, String winnerSymbol, String winnerName, AnchorPane anchorPane) {

        //init(stage, winnerSymbol, winnerName, anchorPane);
    ...
    public FXMLResultWinBase(Stage stage, String winnerSymbol, AnchorPane anchorPane) {
        ...
        //init(stage,null, winnerSymbol, anchorPane);
        mediaViewVideoWin = new MediaView();
        labelCongratulation = new Label();
        labelName = new Label();
        buttonBackHome = new Button();
